package ec.edu.espe.soap_dotnet_bank.ui.viewmodel
...
import ec.edu.espe.soap_dotnet_bank.data.repository.EurekaBankRepository
...
class TransferenciaViewModel : ViewModel() {
    ...
    fun realizarTransferencia(cuentaOrigen: String, cuentaDestino: String, importe: Double) {
        ...
        viewModelScope.launch {
            try {
                val result = repository.registrarTransferencia(cuentaOrigen, cuentaDestino, importe)
